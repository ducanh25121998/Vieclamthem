$(window).on("load", function() {
    ...
    $(".test-jb").on("click",function(){
        $(".post-popup.test").addClass("active");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".post-project > a").on("click", function(){
        $(".post-popup.test").removeClass("active");
        $(".wrapper").removeClass("overlay");
        return false;
    });
    $(".testt-jb").on("click",function(){
        $(".post-popup.testt").addClass("active");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".post-project > a").on("click", function(){
        $(".post-popup.testt").removeClass("active");
        $(".wrapper").removeClass("overlay");
        return false;
    });

    $(".hosontd-jb").on("click",function(){
        $(".post-popup.taohosontd").addClass("active");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".post-project > a").on("click", function(){
        $(".post-popup.taohosontd").removeClass("active");
        $(".wrapper").removeClass("overlay");
        return false;
    });
    $(".tintimviec-jb").on("click",function(){
        $(".post-popup.timviec").addClass("active");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".post-project > a").on("click", function(){
        $(".post-popup.timviec").removeClass("active");
        $(".wrapper").removeClass("overlay");
        return false;
    });
